...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MenuItem.host'
        db.alter_column('domain_menuitem', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domain.Host'], null=True))

    def backwards(self, orm):

        # Changing field 'MenuItem.host'
        db.alter_column('domain_menuitem', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['domain.Host']))
